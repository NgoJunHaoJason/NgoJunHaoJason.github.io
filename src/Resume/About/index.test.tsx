...
import About, { AboutLinks, AboutItemProps, AboutItem } from "Resume/About";
...
describe("About", () => {
  ...
  it("renders AboutItem within AboutLinks", () => {
    ...
    expect(
      within(screen.getByTestId("about-links")).getByTestId("about-item")
    ).toBeInTheDocument();
  });
  ...
  it("renders text within AboutItem", () => {
    ...
    expect(
      within(screen.getByTestId("about-item")).getByText("text")
    ).toBeInTheDocument();
  });
});
